...
Clima_Suicidio %>% 
  ...
  geom_smooth(aes(colour = Pais), method = "lm", formula = y ~ poly(x,2)) +
...
Clima_Suicidio %>% 
  ...
  geom_smooth(aes(colour = Pais), method = "lm", formula = y ~ poly(x,2), show.legend = FALSE) +
...
Añadir descripción del objetivo 4
...
#### **Conclusiones**
En las gráficas obtenidas podemos visualizar cómo ...