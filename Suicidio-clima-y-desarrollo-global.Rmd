...
#####Paises_Escogidos_Altos

```{r, echo=FALSE, message=FALSE, Paises_Escogidos_Altos}
...
#####Países_Escogidos_Bajos

```{r, echo=FALSE, message=FALSE, Paises_Escogidos_Bajos}
